    ...
    return (
        <>
            ...
            <Card sx={{ Width: "375px", height: "490px", position: "relative", zIndex: -2 }}>
                <Avatar sx={{ height: "146px", width: "146px", position: "absolute", top: "50px", left: "100px", zIndex: 2 }} src={`http://localhost:3000/uploads/${bussiness?.profilePic}`} alt={bussiness?.name}></Avatar>
