...
const BussinessWorkshops = () => {
  return (
    <>
      <BussinessNavbar />
      <Container maxWidth="x-lg" sx={{ mt: "100px", mb: "50px" }}>
        <Box display={'flex'} flexDirection={'column'} alignItems={'center'} justifyContent={'center'}>
          <Typography variant='h4' color='secondary' sx={{ mb: "50px" }}>Manage Workshops</Typography>
          {/* Add Workshops specific UI here */}
          <Stack spacing={2} direction="column" alignItems="center">
            <Typography variant='h6'>Add Workshops</Typography>
            ...
            <Typography variant='h6'>View Workshops</Typography>
            ...
            <hr style={{ width: '100%', margin: '20px 0' }} />
            <Typography variant='h6'>Edit Workshops</Typography>
            <Typography variant='p'>Organizer name: [Text Field]</Typography>
            <Typography variant='p'>Organizer Email: [Email Field]</Typography>
            <Typography variant='p'>Phone number: [Number Field]</Typography>
...
export default BussinessWorkshops;
