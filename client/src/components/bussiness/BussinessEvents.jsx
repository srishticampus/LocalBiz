    ...
    <>
      ...
      <Container maxWidth="x-lg" sx={{ mt: "100px", mb: "50px" }}>
        <Box display={'flex'} flexDirection={'column'} alignItems={'center'} justifyContent={'center'}>
          <Typography variant='h4' color='secondary' sx={{ mb: "50px" }}>Manage Events</Typography>
          {/* Add Events specific UI here */}
          <Stack spacing={2} direction="column" alignItems="center">
            <Typography variant='h6'>View Events</Typography>
            <Typography variant='p'>Event type: [Dynamic Value]</Typography>
            ...
            <Typography variant='p'>Event Name: [Text Field]</Typography>
